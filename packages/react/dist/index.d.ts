...
declare function Toast({ description, title, ...rest }: ToastProps): JSX.Element;

interface TooltipProps extends ComponentProps<typeof TooltipPrimitive.Root> {
    content: string;
}
declare function Tooltip({ children, content, ...rest }: TooltipProps): JSX.Element;
...
declare function useToast(): ToastContextProps;
...
export { Avatar, AvatarProps, Box, BoxProps, Button, ButtonProps, Checkbox, CheckboxProps, Heading, HeadingProps, MultiStep, MultiStepProps, Text, TextInput, TextInputProps, TextProps, Textarea, TextareaProps, Toast, ToastContext, ToastProps, ToastProvider, Tooltip, TooltipProps, config, createTheme, css, globalCss, keyframes, styled, theme, useToast };
